...
def depthFirstSearch(problem):
    ...
    frontier.push((start_state, actions))  # save actions history of current state
...
def uniformCostSearch(problem):
    ...
    start_state = problem.getStartState()
    # save actions history and total cost of current state
    frontier.push((start_state, actions), 0)
...
def myHeuristic(state, problem=None):
    ...
    """
    "*** YOUR CODE HERE ***"
    return util.manhattanDistance(problem.goal, state)
