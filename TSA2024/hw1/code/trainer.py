...
from src.utils.metrics import mae, mape, mase, mse, smape
...
class MLTrainer:
    ...
    def train(self):
        train_X = self.dataset.train_data[:, :, -1]
    ...
    def evaluate(self, dataset, seq_len=96, pred_len=32):
        ...
        te_X = self.transform.transform(test_X, test=True)  # use params calculated during training
